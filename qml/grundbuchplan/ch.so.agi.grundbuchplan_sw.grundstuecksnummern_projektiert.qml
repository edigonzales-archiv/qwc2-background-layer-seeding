...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="1" maximumScale="5000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <labeling type="rule-based">
    <rules key="{1e9bec9b-1531-4557-b89f-2015beb87bef}">
      <rule scalemaxdenom="300" key="{19e7712f-d5b2-4eb0-89c6-b62b30a26f79}" scalemindenom="1">
        <settings>
          <text-style fontItalic="0" fontFamily="Frutiger LT Com 55 Roman" fontLetterSpacing="0" fontUnderline="1" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="255,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="12.6" fieldName="nummer" namedStyle="75 Black" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
      ...
      <rule scalemaxdenom="750" key="{3b7e33fc-b12c-4c25-9e3d-12b1febe6af1}" scalemindenom="300">
        <settings>
          <text-style fontItalic="0" fontFamily="Frutiger LT Com 55 Roman" fontLetterSpacing="0" fontUnderline="1" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="255,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="12.6" fieldName="nummer" namedStyle="75 Black" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
      ...
      <rule scalemaxdenom="1250" key="{f77dbd6a-c7cf-4db3-9ebf-25575ed9df98}" scalemindenom="750">
        <settings>
          <text-style fontItalic="0" fontFamily="Frutiger LT Com 55 Roman" fontLetterSpacing="0" fontUnderline="1" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="255,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="9" fieldName="nummer" namedStyle="75 Black" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          <text-format placeDirectionSymbol="0" multilineAlign="3" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
          <text-buffer bufferSize="0.5" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="1" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="0" bufferNoFill="0" bufferJoinStyle="128"/>
      ...
      <rule scalemaxdenom="3000" key="{4ad3da5d-71ff-453a-95d9-4ba0f9230a21}" scalemindenom="1250">
        <settings>
          <text-style fontItalic="0" fontFamily="Frutiger LT Com 55 Roman" fontLetterSpacing="0" fontUnderline="1" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="255,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6.3" fieldName="nummer" namedStyle="75 Black" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          <text-format placeDirectionSymbol="0" multilineAlign="3" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
      ...
      <rule scalemaxdenom="6000" key="{4c2f58e0-685c-4bb2-b030-f6dd0780ed18}" scalemindenom="3000">
        <settings>
          <text-style fontItalic="0" fontFamily="Frutiger LT Com 55 Roman" fontLetterSpacing="0" fontUnderline="1" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="255,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="3.5" fieldName="nummer" namedStyle="75 Black" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          <text-format placeDirectionSymbol="0" multilineAlign="3" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
  ...
  <aliases>
    ...
    <alias field="geometrie" index="14" name=""/>
  </aliases>
