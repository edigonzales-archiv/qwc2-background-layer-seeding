...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="1" maximumScale="5000" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="Hidden" name="ori">
    ...
    <edittype widgetv2type="Hidden" name="hali_txt">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="vali">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="Hidden" name="vali_txt">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="Hidden" name="y">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="Hidden" name="x">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="Hidden" name="rot">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="nummer">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="Hidden" name="art">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <rules key="{24af3a12-a266-483c-a334-9c73772cf438}">
      <rule scalemaxdenom="750" filter=" &quot;mutation&quot;  =  'f' " key="{1f219c1a-aebb-46f2-b3d1-6f9afeef15cc}" scalemindenom="1">
        <settings>
          ...
          <data-defined>
            <PositionX expr="$x" field="x" active="true" useExpr="true"/>
            <PositionY expr="$y" field="x" active="true" useExpr="true"/>
            <Hali expr="" field="hali_txt" active="true" useExpr="false"/>
            <Vali expr="" field="vali_txt" active="true" useExpr="false"/>
            <Rotation expr="" field="rot" active="true" useExpr="false"/>
          </data-defined>
        </settings>
      </rule>
      <rule scalemaxdenom="1250" filter=" &quot;mutation&quot;  =  'f' " key="{2e47a52f-42cc-45ad-8b17-9ab19b0abdf5}" scalemindenom="750">
        <settings>
      ...
      <rule scalemaxdenom="3000" filter=" &quot;mutation&quot;  =  'f' " key="{ad196b87-67d8-46d7-84d8-245973f48079}" scalemindenom="1250">
        <settings>
      ...
      <rule scalemaxdenom="6000" filter=" &quot;mutation&quot;  =  'f' " key="{06731101-ca02-471a-8a43-7de9af68721a}" scalemindenom="3000">
        <settings>
  ...
  <customproperties>
    ...
    <property key="labeling/namedStyle" value="76 Black Italic"/>
  ...
  <aliases>
    ...
    <alias field="grundstueckpos_von" index="2" name=""/>
    ...
    <alias field="hilfslinie" index="10" name=""/>
    ...
    <alias field="rot" index="16" name=""/>
    <alias field="nummer" index="17" name=""/>
    <alias field="art" index="18" name=""/>
    <alias field="mutation" index="19" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="grundstueckpos_von"/>
      ...
      <column width="-1" hidden="0" type="field" name="hilfslinie"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="grundstueckpos_von" expression=""/>
    ...
    <default field="hilfslinie" expression=""/>
