...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="kantonsname">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="kantonskuerzel">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" preprocessing="0" type="invertedPolygonRenderer" enableorderby="0">
    <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
      <rules key="{e826f8b2-1fb4-42b0-a716-6f907f6da190}">
        <rule scalemaxdenom="4000000" key="{1787a3ad-3088-4887-923d-22aa77cd77de}" symbol="0" scalemindenom="50000"/>
        <rule scalemaxdenom="50000" key="{6366503a-454d-4c8a-9a83-617b2aa15d6d}" symbol="1" scalemindenom="1"/>
      </rules>
      <symbols>
        ...
        <symbol alpha="1" clip_to_extent="1" type="fill" name="1">
          <layer pass="0" class="SimpleLine" locked="0">
            ...
            <prop k="draw_inside_polygon" v="0"/>
            <prop k="joinstyle" v="bevel"/>
            <prop k="line_color" v="255,255,255,166"/>
            <prop k="line_style" v="solid"/>
  ...
  <aliases>
    ...
    <alias field="kantonsname" index="2" name=""/>
    <alias field="kantonskuerzel" index="3" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="kantonsname"/>
      <column width="-1" hidden="0" type="field" name="kantonskuerzel"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="kantonsname" expression=""/>
    <default field="kantonskuerzel" expression=""/>
