...
<qgis version="2.18.17" simplifyAlgorithm="0" minimumScale="1" maximumScale="5000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{3d0d9afb-8102-4cd4-9108-7f65ef2dff65}">
      <rule filter="&quot;art_txt&quot; = 'Gas'" key="{6fce1dc1-cf14-472a-a71c-c8587ad17af7}" label="Gas">
        <rule scalemaxdenom="300" key="{ea2d7156-19aa-4a89-8d0a-6d6b42d7953e}" symbol="0" scalemindenom="1" label="1:250"/>
        <rule scalemaxdenom="750" key="{9bfb8308-503e-408f-892b-bcbf370c43de}" symbol="1" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{8b5a78bb-7d11-4898-be87-15c6d32a6d59}" symbol="2" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{cd000b59-8985-4f1c-9b3e-a204bf70c4df}" symbol="3" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="6000" key="{84df0586-9328-436e-840d-61ca0b9e0790}" symbol="4" scalemindenom="3000" label="1:5000"/>
      </rule>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="betreiber" index="4" name=""/>
    <alias field="bfs_nr" index="5" name=""/>
