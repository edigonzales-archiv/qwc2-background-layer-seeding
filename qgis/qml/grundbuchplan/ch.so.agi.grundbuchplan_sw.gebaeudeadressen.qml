...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="1" maximumScale="5000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="edid">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="ist_offizielle_bezeichnung">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <labeling type="rule-based">
    <rules key="{5ccaa2ab-c5f3-4886-9f2e-0d21e5144593}">
      <rule scalemaxdenom="750" key="{36754ab2-a342-438a-9e5d-9cff226c58d5}" scalemindenom="1">
        <settings>
          <text-style fontItalic="0" fontFamily="Cadastra" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="9.800000000000001" fieldName="hausnummer" namedStyle="Normal" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
      ...
      <rule scalemaxdenom="1250" key="{caba903e-8c24-4020-89ad-f209d7bd9f99}" scalemindenom="750">
        <settings>
          <text-style fontItalic="0" fontFamily="Cadastra" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="7" fieldName="hausnummer" namedStyle="Normal" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          <text-format placeDirectionSymbol="0" multilineAlign="3" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
          <text-buffer bufferSize="0.5" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="1" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="0" bufferNoFill="0" bufferJoinStyle="128"/>
      ...
      <rule scalemaxdenom="3000" key="{7389e2bf-db4c-442f-aff7-81ee264fe1ef}" scalemindenom="1250">
        <settings>
          <text-style fontItalic="0" fontFamily="Cadastra" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="4.9" fieldName="hausnummer" namedStyle="Normal" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          <text-format placeDirectionSymbol="0" multilineAlign="3" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
      ...
      <rule scalemaxdenom="6000" key="{df62532c-d981-44ef-944d-5485f3425994}" scalemindenom="3000">
        <settings>
          <text-style fontItalic="1" fontFamily="Cadastra" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="3.5" fieldName="hausnummer" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          <text-format placeDirectionSymbol="0" multilineAlign="3" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" sizeLegend="0" attributeLegend="1">
    <DiagramCategory penColor="#000000" labelPlacementMethod="XHeight" penWidth="0" diagramOrientation="Up" sizeScale="0,0,0,0,0,0" minimumSize="0" barWidth="5" penAlpha="255" maxScaleDenominator="1e+08" backgroundColor="#ffffff" transparency="0" width="15" scaleDependency="Area" backgroundAlpha="255" angleOffset="1440" scaleBasedVisibility="0" enabled="0" height="15" lineSizeScale="0,0,0,0,0,0" sizeType="MM" lineSizeType="MM" minScaleDenominator="inf">
      <fontProperties description="Cadastra,9,-1,5,50,0,0,0,0,0" style=""/>
    </DiagramCategory>
  ...
  <aliases>
    ...
    <alias field="hausnummer" index="3" name=""/>
    <alias field="egid" index="4" name=""/>
    <alias field="edid" index="5" name=""/>
    <alias field="plz" index="6" name=""/>
    <alias field="ortschaft" index="7" name=""/>
    <alias field="status" index="8" name=""/>
    <alias field="ist_offizielle_bezeichnung" index="9" name=""/>
    <alias field="hoehenlage" index="10" name=""/>
    <alias field="gebaeudename" index="11" name=""/>
    <alias field="bfs_nr" index="12" name=""/>
    <alias field="orientierung" index="13" name=""/>
    <alias field="hali" index="14" name=""/>
    <alias field="vali" index="15" name=""/>
    <alias field="importdatum" index="16" name=""/>
    <alias field="nachfuehrung" index="17" name=""/>
    <alias field="lage" index="18" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="edid"/>
      ...
      <column width="-1" hidden="0" type="field" name="ist_offizielle_bezeichnung"/>
      <column width="-1" hidden="0" type="field" name="hoehenlage"/>
      <column width="-1" hidden="0" type="field" name="gebaeudename"/>
      ...
      <column width="-1" hidden="0" type="field" name="lage"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="edid" expression=""/>
    <default field="plz" expression=""/>
    <default field="ortschaft" expression=""/>
    <default field="status" expression=""/>
    <default field="ist_offizielle_bezeichnung" expression=""/>
    <default field="hoehenlage" expression=""/>
    <default field="gebaeudename" expression=""/>
