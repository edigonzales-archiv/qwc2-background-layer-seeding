...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="1" maximumScale="3000" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="schoener_stein">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="lagegenauigkeit">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="lagezuverlaessigkeit">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="symbolorientierung">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{8ac0cf19-127c-49fb-8f3f-23efcc110408}">
      <rule filter="punktzeichen_txt = 'Stein'" key="{71852341-79a2-4488-b6bf-92fe63ae702c}" label="Stein">
        <rule scalemaxdenom="300" key="{e8be8e80-6316-48e0-b042-7467b384ed4b}" symbol="0" scalemindenom="1" label="1:250"/>
        <rule scalemaxdenom="750" key="{dc7855e9-2be2-4d9f-b926-fb279bbb9383}" symbol="1" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{a1ac501b-2cec-44c0-a660-ab7e8fa36f20}" symbol="2" scalemindenom="700" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{0e46f377-1ef2-4ff5-b3b3-ba2c986781c8}" symbol="3" scalemindenom="1250" label="1:2000"/>
      </rule>
      <rule filter="punktzeichen_txt = 'Kunststoffzeichen'" key="{dfb3f0f5-845d-43e1-9500-b99d2874c1e5}" label="Kunststoffzeichen">
        <rule scalemaxdenom="300" key="{c0272c33-70ce-4da2-ae26-235240aa0556}" symbol="4" scalemindenom="1" label="1:250"/>
        <rule scalemaxdenom="750" key="{2ad13ae8-d87e-4739-8a0c-64b15e916b36}" symbol="5" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{9a426918-ab27-49c1-8290-359282540291}" symbol="6" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{a7360634-9538-40fc-a56d-d3a54f34b481}" symbol="7" scalemindenom="1250" label="1:2000"/>
      </rule>
      <rule filter="punktzeichen_txt = 'Bolzen'" key="{e504e6e2-b619-4d2d-9696-2fecee4ce98d}" label="Bolzen">
        <rule scalemaxdenom="300" key="{0d4ee094-4cbd-4985-8be9-748e8e0cd4e2}" symbol="8" scalemindenom="1" label="1:250"/>
        <rule scalemaxdenom="750" key="{281f0c35-24d3-483c-a32a-020483bd71b7}" symbol="9" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{3ea0ec1c-f96b-488c-9934-591a47b20b63}" symbol="10" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{a99a4e70-ed61-4203-bbd7-c84e9a8a9e56}" symbol="11" scalemindenom="1250" label="1:2000"/>
      </rule>
      <rule filter="punktzeichen_txt = 'Rohr'" key="{ce51da33-510e-4b05-a8c6-daf3cc4026c8}" label="Rohr">
        <rule scalemaxdenom="300" key="{0da23fff-97e1-45ee-9e5d-8a023b363b48}" symbol="12" scalemindenom="1" label="1:250"/>
        <rule scalemaxdenom="750" key="{8a044517-2902-4908-9516-2748872bb4dc}" symbol="13" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{f16ddc5d-0bbe-4009-8bde-092d99c5632e}" symbol="14" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{c075e999-0323-4dba-9e51-1cfd2f3ca4e9}" symbol="15" scalemindenom="1250" label="1:2000"/>
      </rule>
      <rule filter="punktzeichen_txt = 'Pfahl'" key="{7763f1ec-e901-43c3-9d88-b16a26da3856}" label="Pfahl">
        <rule scalemaxdenom="300" key="{613f10a9-0e1f-4106-9f5e-da59b9346837}" symbol="16" scalemindenom="1" label="1:250"/>
        <rule scalemaxdenom="750" key="{52a8902a-4c8f-4369-812c-6f0bd6967325}" symbol="17" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{58f1bef0-6030-4ea1-9685-28a156efe4fa}" symbol="18" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{be3526b3-53d5-4399-a861-e46626eab3fa}" symbol="19" scalemindenom="1250" label="1:2000"/>
      </rule>
      <rule filter="punktzeichen_txt = 'Kreuz'" key="{5d6cd39d-eb97-48b4-9ac3-c5623f0138a8}" label="Kreuz">
        <rule scalemaxdenom="300" key="{20e00b8c-dfbd-423f-8b84-c58ad6cd160e}" symbol="20" scalemindenom="1" label="1:250"/>
        <rule scalemaxdenom="750" key="{b4450a3f-b9e0-4ce2-8226-99ae538f3eb7}" symbol="21" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{d3e24f6f-fe26-470d-b476-f36b0e9f88fc}" symbol="22" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{d06fe515-f6d3-4bbb-b4ce-c30b0be40d0d}" symbol="23" scalemindenom="1250" label="1:2000"/>
      </rule>
      <rule filter="punktzeichen_txt = 'unversichert'" key="{8c261513-1e3d-4e1e-87e2-8ab51aee311a}" label="unversichert">
        <rule scalemaxdenom="300" key="{aed18385-8603-4843-af83-a0e0bd93a528}" symbol="24" scalemindenom="1" label="1:250"/>
        <rule scalemaxdenom="750" key="{56cdf071-9db3-4891-9e89-de53d2fb0638}" symbol="25" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{f8cccf04-12b0-477b-8ec0-f76bc243ad4e}" symbol="26" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{c31422e9-4f57-4d7f-b757-46eb185a8bfd}" symbol="27" scalemindenom="1250" label="1:2000"/>
      </rule>
    </rules>
    <symbols>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="schoener_stein"/>
      <column width="-1" hidden="0" type="field" name="lagegenauigkeit"/>
      <column width="-1" hidden="0" type="field" name="lagezuverlaessigkeit"/>
      <column width="-1" hidden="0" type="field" name="symbolorientierung"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="schoener_stein" expression=""/>
    <default field="lagegenauigkeit" expression=""/>
    <default field="lagezuverlaessigkeit" expression=""/>
    <default field="symbolorientierung" expression=""/>
