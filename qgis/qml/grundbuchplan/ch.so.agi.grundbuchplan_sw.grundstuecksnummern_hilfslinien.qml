...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="1" maximumScale="5000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{b5d0a0f2-e3f6-4395-a487-250d3054237d}">
      <rule filter=" $geometry is not null" key="{2be1d36d-f5e6-4cbf-8c4a-f5318c77080b}">
        <rule scalemaxdenom="300" key="{f5dd9bf0-1d10-4d81-9bae-3bc5c84d0fdd}" symbol="0" scalemindenom="1" label="1:250"/>
        <rule scalemaxdenom="750" key="{739e38ea-5df0-4b8b-8cdf-5a8d81c70b24}" symbol="1" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{dfd3c606-3149-439a-883c-a8ab98928b85}" symbol="2" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{792251d6-b2e4-4c86-a27c-ea0bcc5a5a5b}" symbol="3" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="6000" key="{ee15abec-ac26-440b-ab27-8d3625b2007b}" symbol="4" scalemindenom="3000" label="1:5000"/>
      </rule>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="pos" index="3" name=""/>
    <alias field="ori" index="4" name=""/>
    <alias field="hali" index="5" name=""/>
    <alias field="hali_txt" index="6" name=""/>
    <alias field="vali" index="7" name=""/>
    <alias field="vali_txt" index="8" name=""/>
    <alias field="groesse" index="9" name=""/>
    <alias field="groesse_txt" index="10" name=""/>
